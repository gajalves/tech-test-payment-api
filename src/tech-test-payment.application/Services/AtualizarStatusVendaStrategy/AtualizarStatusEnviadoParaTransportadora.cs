...
public class AtualizarStatusEnviadoParaTransportadora : IAtualizarStatusVenda
{
    private readonly VendaStatus StatusAtual = VendaStatus.EnviadoParaTransportadora;
    public Result AlterarStatusDaVenda(Venda venda, VendaStatus novoStatus)
    {
        var permiteAlterar = novoStatus != StatusAtual && 
                             novoStatus == VendaStatus.Entregue;
